...
ArrayList<Note> items = new ArrayList<Note>();
    ...
    // 어댑터 클래스 상속시 구현해야하는 함수 3가지 , onCreateViewHolder, onBindViewHolder, getItemCount
    // 리사이뷰에 들어갈 뷰 홀더를 할당하는 함수, 뷰 홀더 실제 레이아웃 파일과 매핑되어야 한다.
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, final NoteAdapter listener, int layoutType) {
            super(itemView);
